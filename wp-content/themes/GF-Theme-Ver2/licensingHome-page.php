<?php
/**
 * Template Name: Licensing Home Template
 *
...
get_header(); ?>
	...
	<div class="maincontainer">
		...
		<div class="threecol-contentcontainer">
			...
			<?php if ( is_active_sidebar( 'licensing-home-subpage-teaser' ) ) : ?>
				<div id="subpage-teaser" class="licensingcontent-subpage-teaser">
					<?php dynamic_sidebar( 'licensing-home-subpage-teaser' ); ?>
				</div>
			<?php endif; ?>		
		</div>
		<?php if ( is_active_sidebar( 'licensing-home-right-sidebar' ) && get_the_ID() != $faq_page_id ) : ?>
