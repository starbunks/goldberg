<li class="widget-container widget_text">
	...
	<?php 	
	$args = array( "child_of" => 48, "include" => array(211,207,52,213,970,1836,50) );
	...
	foreach($bioPages as $orderPage){
		switch($orderPage->ID){
			...
			case 52:
				...
				break;
			case 213:
				$orderedPages[3] = $orderPage;
				break;				
			case 970:
				$orderedPages[4] = $orderPage;
				break;
			case 1836:
				$orderedPages[5] = $orderPage;
				break;
			case 50:
				$orderedPages[6] = $orderPage;
				break;
		}
	}
	ksort($orderedPages);
