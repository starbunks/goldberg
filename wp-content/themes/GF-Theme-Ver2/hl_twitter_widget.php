...
div ul.hl_recent_tweets{
	margin:0;
	padding:0;
}

.hl_recent_tweets div {
	<?php if($show_avatars): ?>
...
<?php if($num_tweets>0): ?>
	<ul class="hl_recent_tweets">
		<?php foreach($tweets as $tweet): ?>
			<div <?php if($show_avatars): ?>style="background-image:url(<?php echo hl_twitter_get_avatar($tweet->avatar); ?>)"<?php endif; ?>>
				<p>
...
<p class="hl_recent_tweets_meta">
	<?php if($show_more_link): ?><a href="<?php echo "?page_id=840";//hl_twitter_get_archives_root(); ?><?php if($single_user) echo '/'.$user->screen_name; ?>">View more tweets</a><?php endif; ?>
